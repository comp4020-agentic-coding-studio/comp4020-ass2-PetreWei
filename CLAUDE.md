...
- **Write each moment in STAR form, weighted.** Situation 20% — the specific difficulty you were in, not the general state of things; Task 10% — what you had to achieve, and a target you set yourself says more than one handed to you; Action 60% — what you did, why you did it, and what the alternatives were; Result 10% — the outcome, measured where it can be, and what you learned. The weighting is the rule: an even split just recounts events, while spending most of the words on your own actions and the alternatives you rejected is what makes a capability visible. Name the method, not only its outcome.
